...
@section('content')
    <div class="container">
        <h4 class="mb-4"><i class="bi bi-book text-primary"></i> Tutorial</h4>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small text-muted">The dashboard provides an overview of your financial status. It shows
                            key metrics and summaries at a glance.</p>

                        <hr>

                        <h6><i class="bi bi-diagram-3 text-primary"></i> 2. Cost Centres</h6>
                        <p class="small text-muted">Cost Centres are used to organize and track expenses by department or
                            project. Only admins can manage cost centres.</p>

                        <hr>

                        <h6><i class="bi bi-wallet2 text-primary"></i> 3. Accounts</h6>
                        <p class="small text-muted">Accounts represent different expense categories (e.g., Travel, Supplies,
                            Salaries). Finance users and admins can manage accounts.</p>

                        <hr>

                        <h6><i class="bi bi-calculator text-primary"></i> 4. Budgets</h6>
                        <p class="small text-muted">Create and manage budgets for each cost centre. Budgets are organized by
                            year and month using budget lines.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small text-muted">Record actual expenses against your budget line items. You can add
                            details to actuals for better tracking.</p>

                        <hr>

                        <h6><i class="bi bi-upload text-success"></i> 6. Import</h6>
                        <p class="small text-muted">Import actuals from CSV files. Download the template to ensure proper
                            data formatting.</p>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small text-muted">Set up alerts to be notified when spending exceeds budget thresholds.
                        </p>

                        <hr>

                        <h6><i class="bi bi-cpu text-warning"></i> 10. AI Analysis</h6>
                        <p class="small text-muted">Use AI-powered analysis to gain insights into your spending patterns.
                        </p>

                        <hr>

                        <h6><i class="bi bi-pie-chart text-warning"></i> 11. Charts</h6>
                        <p class="small text-muted">Visualize your financial data with various charts including monthly
                            trends, account distribution, and variance analysis.</p>

                        <hr>

                        <h6><i class="bi bi-bar-chart text-warning"></i> 12. Power BI</h6>
                        <p class="small text-muted">Connect to Power BI for advanced business intelligence and reporting
                            capabilities.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small text-muted">Manage your profile and change your password. Admins can access
                            additional system settings.</p>
