...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4><i class="bi bi-calculator"></i> Budgets</h4>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#budgetModal" data-mode="create">Add Budget</button>
    </div>
            ...
            <form id="budgetForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="annual_budget" id="budgetAmount" class="form-control" step="0.01" required>
                    </div>
                    <div class="mb-3">
                        <label>Year</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    budgetModal.addEventListener('show.bs.modal', function(event) {
        ...
        if (mode === 'create') {
            ...
            document.getElementById('budgetCostCentre').value = button.getAttribute('data-cost_centre_id');
            document.getElementById('budgetAccount').value = button.getAttribute('data-account_id');
            document.getElementById('budgetAmount').value = button.getAttribute('data-annual_budget');
