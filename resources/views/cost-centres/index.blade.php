...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#costCentreModal" data-mode="create">Add Cost Centre</button>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    costCentreModal.addEventListener('show.bs.modal', function(event) {
        ...
        if (mode === 'create') {
            ...
            document.getElementById('costCentreStatus').value = button.getAttribute('data-status') || 'active';
        }
    });
});
</script>
